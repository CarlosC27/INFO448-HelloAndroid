...
Pointer Location Tool- It draws the movement of your finger along the screen while also showing coordinates. If I were to create an application that relies a lot on touch drag especially if it requieres percise movement it would be very useful!
